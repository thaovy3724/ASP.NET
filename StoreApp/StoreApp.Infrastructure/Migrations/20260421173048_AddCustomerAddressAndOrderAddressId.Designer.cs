...
namespace StoreApp.Infrastructure.Migrations
{
    ...
    [Migration("20260421173048_AddCustomerAddressAndOrderAddressId")]
    partial class AddCustomerAddressAndOrderAddressId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreApp.Core.Entities.CustomerAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("StoreApp.Core.Entities.Order", b =>
                {
                    b.HasOne("StoreApp.Core.Entities.CustomerAddress", null)
                        .WithMany()
