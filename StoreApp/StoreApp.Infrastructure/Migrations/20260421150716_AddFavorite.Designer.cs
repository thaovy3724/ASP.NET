...
namespace StoreApp.Infrastructure.Migrations
{
    ...
    [Migration("20260421150716_AddFavorite")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreApp.Core.Entities.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("StoreApp.Core.Entities.Favorite", b =>
                {
                    b.HasOne("StoreApp.Core.Entities.User", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("StoreApp.Core.Entities.Product", "Product")
                        .WithMany()
